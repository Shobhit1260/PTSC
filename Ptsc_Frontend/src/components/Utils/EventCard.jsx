...
function EventCard({Title,Description,Year,Month,date,Time}) {
  ...
  return (
    <div className='w-11/12 h-min bg-white shadow-lg rounded-lg p-8 mt-8 mx-8 flex justify-between items-start gap-4'>
        <div className='w-1/2 h-min bg-white  mx-8 flex flex-col justify-center items-start gap-4'>
            <h1 className='font-bold text-black text-2xl'>{Title}</h1>
            <p className='text-gray-500'>{Description}</p>
            <span className='text-gray-400'>{`${date}-${Month}-${Year}`}</span>
